...
import Showers from '@/assets/showers_128.png'
import Sunny from '@/assets/sunny_128.png'
import Cloudy from '@/assets/cloudy_128.png'
export const initCustomizeChart = function (id: string) {
  const { globalProperties } = useCurrentInstance()
  const $echarts = globalProperties.$echarts
  const myChart = $echarts.init(document.getElementById(id))
  API.getCustomizeData().then(res => {
